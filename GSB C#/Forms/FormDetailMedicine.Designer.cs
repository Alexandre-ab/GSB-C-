namespace GSB_C_.Forms
{
    partial class FormDetailMedicine
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelHeader.Controls.Add(buttonTopMedicines);
            ...
            // buttonTopMedicines
            // 
            buttonTopMedicines.BackColor = Color.FromArgb(255, 193, 7);
            buttonTopMedicines.FlatAppearance.BorderSize = 0;
            buttonTopMedicines.FlatStyle = FlatStyle.Flat;
            buttonTopMedicines.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            buttonTopMedicines.ForeColor = Color.White;
            buttonTopMedicines.Location = new Point(620, 10);
            buttonTopMedicines.Name = "buttonTopMedicines";
            buttonTopMedicines.Size = new Size(170, 40);
            buttonTopMedicines.TabIndex = 1;
            buttonTopMedicines.Text = " TOP 10";
            buttonTopMedicines.UseVisualStyleBackColor = false;
            buttonTopMedicines.Click += buttonTopMedicines_Click;
            // 
            // labelTitle
            // 
        ...
        private Button buttonTopMedicines;
    }
}